...
* Vital statistics:
  ...
  System requirements: Any combination of MORECORE and/or MMAP/MUNMAP
       ...
       MORECORE and MMAP are enabled.  On MSWindows, it uses emulations
...
WIN32                    default: defined if _WIN32 defined
  ...
  MSWindows malloc: Random-looking failures from MSWindows GDI API's (eg;
...
USE_BUILTIN_FFS            default: 0 (i.e., not used)
  ...
  this setting has no effect. Similarly for MSWindows under recent MS compilers.
...
/* MSWindows MMAP via VirtualAlloc */
...
History:
    V2.8.4 (not yet released)
      ...
      * MSWindows improvements, courtesy of Niall Douglas and Earl Chew
